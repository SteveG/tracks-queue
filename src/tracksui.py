...
"QWidget#widget_5 {background-color:palette(window);}"))
        ...
        self.projectview_page.setStyleSheet(_fromUtf8("QWidget#projectview_page {background-color:palette(window);}"))
...
"QWidget#widget_6 {background-color:palette(window);}"))
        ...
        self.contextview_page.setStyleSheet(_fromUtf8("QWidget#contextview_page {background-color:palette(window);}"))
